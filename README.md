...
This project is a web application for analyzing CT scan images using a machine learning model (RandomForestClassifier). 
It provides  image statistics and a prediction of the image class.
...
# Usage
1.Train your model using model.py. The script loads images from dataset/Data/train/<class_folder> and saves 
the trained model as model.pkl in the project folder.
